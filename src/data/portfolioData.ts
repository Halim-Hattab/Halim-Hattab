...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    media: [
      { type: 'video', src: { desktop: `${import.meta.env.BASE_URL}loop.mp4`, mobile: `${import.meta.env.BASE_URL}loopmobile.mp4` } },
      { type: 'image', src: `${import.meta.env.BASE_URL}object.png` },
      { type: 'image', src: `${import.meta.env.BASE_URL}solid.png` },
      { type: 'image', src: `${import.meta.env.BASE_URL}ui integration fo rmobile.png` }
    ],
  ...
  },
  {
    ...
    media: [
      { type: 'video', src: `${import.meta.env.BASE_URL}photorealistic-render.mp4` },
      { type: 'video', src: `${import.meta.env.BASE_URL}photorealistic-ren.mp4` },
      { type: 'image', src: `${import.meta.env.BASE_URL}screenviewsolid.png` },
      { type: 'image', src: `${import.meta.env.BASE_URL}screenviewtextured.png` }
    ],
  ...
  },
  {
    ...
    media: [
      { type: 'image', src: `${import.meta.env.BASE_URL}website.png` } // Updated image path
    ],
